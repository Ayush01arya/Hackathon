        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                const Color(0xFF4C3BBB),
                const Color(0xFF3F309B),
              ],
        ...
        children: [
          Row(
            children: [
              ...
              const Text('All Members', style: TextStyle(fontSize: 16)),
            ],
          ),
          TextButton(
            onPressed: () {
            ...
            child: const Text(
              'Change',
              style: TextStyle(color: Color(0xFF695EEE), fontSize: 14),
            ),
          ),
        ],
      ),
...
class LocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Location data for $name will be displayed here.',
